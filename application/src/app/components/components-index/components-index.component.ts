...
export class ComponentsIndexComponent {
  components: ComponentCard[] = [
    ...
    {
      title: 'sq-textarea-form-control',
      description: 'Componente de textarea baseado em Reactive Forms com auto-resize e contador',
      icon: '📄',
      status: 'new',
      route: '/textarea-form-control',
      features: [
        'Reactive Forms integrado',
        'Auto-resize automático',
        'Contador de caracteres',
        'Validações min/maxLength',
        'Templates customizados (leftLabel, rightLabel)',
        'ChangeDetectionStrategy.OnPush',
      ],
    },
    {
    ...
    {
      title: 'sq-select-multi / sq-select-multi-tags (Legacy)',
      description: 'Componentes legados de multi-select - use sq-select-multi-form-control em novos projetos',
      icon: '🔴',
      status: 'legacy',
      route: '/select-multi-form-control',
      features: ['Two-way binding', 'Seleção múltipla', 'Mantido para compatibilidade'],
    },
    {
      title: 'sq-textarea (Legacy)',
      description: 'Componente legado de textarea - use sq-textarea-form-control em novos projetos',
      icon: '🔴',
      status: 'legacy',
      route: '/textarea-form-control',
      features: ['Two-way binding', 'Textarea básico', 'Mantido para compatibilidade'],
    },
    {
